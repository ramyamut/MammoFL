...
class Segmentor(object): # The main class
    ...
    def Main_Loop_Function(self):
        ...
        if self.print_off==0: print("[INFO] The dicom file path is: " + str(self.Case))
        ...
        if self.print_off==0: print("[INFO] The breast-air segmentation was successfully processed for this case.")
