...
python3 scripts/execute_deep_libra_preprocessing.py -i ${ds1_dicoms} -o ${ds1_temp}
python3 scripts/execute_deep_libra_preprocessing.py -i ${ds2_dicoms} -o ${ds2_temp}
